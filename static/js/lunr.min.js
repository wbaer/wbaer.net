...
for(var i=0;i<this.length;i++){this.elements[elements[i]]=!0}}else{this.length=0}}
lunr.Set.complete={intersect:function(other){return other},union:function(){return this},contains:function(){return!0}}
lunr.Set.empty={intersect:function(){return this},union:function(other){return other},contains:function(){return!1}}
...
if(frame.str.length==1){noEditNode.final=!0}
...
if(frame.str.length==0){insertionNode.final=!0}
...
if(frame.str.length==1){frame.node.final=!0}
...
if(frame.str.length==1){substitutionNode.final=!0}
...
if(frame.str.length==1){transposeNode.final=!0}
...
return this}
lunr.Query.prototype.isNegated=function(){for(var i=0;i<this.clauses.length;i++){if(this.clauses[i].presence!=lunr.Query.presence.PROHIBITED){return!1}}
return!0}
